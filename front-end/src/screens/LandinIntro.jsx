...
export default function LandingIntro({ onFinish }) {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full h-screen bg-[#0257AC] z-50 flex flex-col items-center justify-center transition-all duration-1000 ${
        animateExit ? "h-16 px-6 py-2 justify-start items-start" : ""
      }`}
    >
      <h1
        className={`text-white text-5xl lg:text-6xl font-bold transition-all duration-1000 ${
      ...
      <h1
        className={`text-white font-bold transition-all duration-1000 ${
          animateExit ? "text-2xl mt-0" : "text-6xl lg:text-7xl"
